...
void printHelpMenu(int &argc, char** &argv) {
   ...
   cout << endl;
   ScreenUtils::CenterString("This program creates a tsv file and a gnp file. The information for");
   ...
   cout << "Where wf?name is the input wfx(wfn) name, and options can be:\n\n"
        << "  -a a1 a2 a3\tDefine the atoms  (a1,a2,a3) used to define the plane." << endl
   ...
   cout << "  -L     \tShow the labels of ALL of the atoms in the wf? file." << endl;
#endif
