...
It can be proven that the electron density can be written as
%
...
%----------------------------------------------------------------------------------------------
\section{Reduced Density Gradient}
%----------------------------------------------------------------------------------------------
...
Further details and algebraic deductions can be found in Refs. \cite{bib:parr1989}
...
%----------------------------------------------------------------------------------------------
\section{{\color{red}Gradient of Density matrix of order 1}}
%----------------------------------------------------------------------------------------------
...
%----------------------------------------------------------------------------------------------
\section{Pair density in momentum space}
%----------------------------------------------------------------------------------------------
...
For open-shell systems, we have a similar situation as for $\rho_2(\vr_1,\vr_2)$. Therefore
